                ...
                <div class="card-body">
                    ...
                    <form action="./addCategory.php" class="forms-sample" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="cateName" name="cateName" placeholder="Name" value="<?php echo !empty($row)?$row['cat_name']:"";?>">
                        </div>
                        <div class="form-group">
                            <label for="cateShortName">ID</label>
                            <input type="text" class="form-control" id="cateShortName" name="cateShortName" placeholder="ID" value="<?php echo !empty($row)?$row['cat_id']:"";?>">
                        </div>
