							...
							<div class="container">							
								<div class="register-form" id="register">
									<form action="login.php" method="post"id="form2">
										...
										<div class="input-box">
											<i ></i>
											<input type="text" placeholder="Nhập username" name="tendk">
										</div>
										<div class="input-box">
											<i ></i>
										...
										<div class="input-box">
											<i ></i>
											<input type="password" placeholder="Nhập mật khẩu" name="passdk">
										</div>
										<div class="input-box">
											<i ></i>
											<input type="password" placeholder="Nhập lại mật khẩu" name="repassdk">
										</div>
